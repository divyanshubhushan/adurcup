...
<body id="page-top">
    ...
    <div id="page-wrapper">
        <header id="site-header" role="banner">
            ...
            <div class="header-top" style="box-shadow:none;height:0">
                <div class="container">
                    <div class="row">
        ...
        <main id="main-content" role="main" style="margin-top:70px">

            
                    <div class='page-wrapper'  >
                        <div class='timeline-header-wrapper'>
                            <div class='cover-container' id="niktin" style="border-radius: 5px;margin: 5px auto 0; ">
                ...
                <div class="wrapper 3buttons" style="padding-left:0;padding-right:0;padding-top:10px;top:-70px">
                    <div class="container" align="center" style="padding:0">
                        <div class="col-md-11" align="center" style="padding:0">
                            <a href="create_event.php" class="col-sm-2 col-sm-offset-1" style="border-radius:10px;background:#666;color:#fff;height:40px;padding-top:10px">
                                Create Event
                            </a>
                            <a href="edit.php" class="col-sm-2 col-sm-offset-1" style="border-radius:10px;background:#666;color:#fff;height:40px;padding-top:10px">
                                Edit Profile
                            </a>
                            ...
                            <a href="products.php" class="col-sm-2 col-sm-offset-1" style="border-radius:10px;background:#666;color:#fff;height:40px;padding-top:10px">
                                Order Now
                            </a>
                    ...
                    <div  align="center">
                        ...
                        <p style="font-size:18px;margin-top:-32px;color:#999;background:#fff;width:200px">Recommendations</p>
                         <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 800px; height: 100px; overflow: hidden;margin-bottom:20px">
                            ...
                            <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 980px; height: 100px; overflow: hidden;">
                                <div>
                                    <a href="products.php"><img u="image" src="img/logo/1_25.JPG" /></a>
                                    
                                </div>
                                <div> <a href="products.php"><img u="image" src="img/logo/1_23.JPG" /></div></a>
                                <div> <a href="products.php"><img u="image" src="img/logo/1_26.JPG" /></div></a>
                                <div> <a href="products.php"><img u="image" src="img/logo/1_27.JPG" /></div></a>
                                <div> <a href="products.php"><img u="image" src="img/logo/1_28.JPG" /></div></a>
                                <div> <a href="products.php"><img u="image" src="img/logo/1_37.JPG" /></div></a>
                                <div> <a href="product.php?id=31"><img u="image" src="img/logo/1_42.JPG" /></div></a>
                                <div> <a href="product.php?id=35"><img u="image" src="img/logo/1_45.JPG" /></div></a>
                            </div>
...
<script type="text/javascript" src="js/jssor.js"></script>
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            $("#jump_to_previous").click(function() {

                $('html, body').animate({
                    scrollTop: $("#previous_orders").offset().top
                }, 2000);
            });
