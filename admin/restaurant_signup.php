			...
			$(document).ready(function() {
				var oTable = $('#example').dataTable( {
					...
					"fnDrawCallback": function () {
						$('#example tbody td:not(:first-child)').editable( 'examples_support/editable_ajax.php', {
		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li class="active"><a  href="restaurant_signup.php" ><i class="icon-tasks"></i><span class="hidden-tablet"> Restaurant Signups</span></a></li>
			...
			<div id="content" class="span10" style="padding-right:0px" >
					...
					<div class="box-header" style="margin-bottom:10px">
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Restaurants Signups</h2>
