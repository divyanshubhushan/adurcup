	...
	<script type="text/javascript" charset="utf-8">
			$(document).ready(function() {
				var oTable = $('#example').dataTable( {
					...
					"bServerSide": true,
					"bJQueryUI": false,
					"sAjaxSource": "server_side/scripts/brand_server.php",
					"aaSorting": [ [0,'desc'] ],
					"sPaginationType": "full_numbers",
					"fnDrawCallback": function () {
						$('#example tbody td:not(:first-child)').editable( 'examples_support/editable_brands.php', {
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="admin.adurcup.com"><span>AdUrCup</span></a>
		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li class="active"><a  href="brand_signup.php"><i class="icon-dashboard"></i><span class="hidden-tablet"> Advertiser Signups</span></a></li>
			...
			<div id="content" class="span10" style="padding-right:0px" >
					...
					<div class="box-header" style="margin-bottom:10px">
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Advertiser Signups</h2>
