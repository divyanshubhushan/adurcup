	...
	<script type="text/javascript" charset="utf-8">
			$(document).ready(function() {
				var oTable = $('#example').dataTable( {
					...
					"bServerSide": true,
					"bJQueryUI": false,
					"sAjaxSource": "server_side/scripts/orders_server_processing.php",
					"aaSorting": [ [0,'desc'] ],
					"sPaginationType": "full_numbers",
					"fnDrawCallback": function () {
						$('#example tbody td').not(":nth-child(1)").not(":nth-child(9)").not(":nth-child(4)").not(":nth-child(10)").not(":nth-child(12)").not(":nth-child(17)").editable( 'examples_support/orders_editable_ajax.php', {
