/**
 * jPList - jQuery Data Grid Controls 5.1.352 - http://jplist.com 
...
(function() {
    var a = function(d, b, c, f) {
        var e = 0,
            g, h;
        0 < c.length && (g = c[f], "default" != g.data.path ? (h = jQuery.fn.jplist.app.services.DTOMapperService.sort[g.data.type], jQuery.isFunction(h) && (e = h(g, d, b))) : (e = d.index, g = b.index, e = e === g ? 0 : isNaN(e) ? 1 : isNaN(g) ? -1 : e - g), 0 === e && f + 1 < c.length && (e = a(d, b, c, f + 1)));
        return e
    };
