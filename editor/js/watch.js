(function(g, f, F) {
    ...
    function pa(a, b) {
        if (!a || !b) return !1;
        for (var c = [], d = 0; d < b.length; d++) c.push(b[d].replace(/\^/g, "\\^").replace(/\$/g, "\\$").replace(/\./g, "\\.").replace(/\[/g, "\\[").replace(/\]/g, "\\]").replace(/\|/g, "\\|").replace(/\(/g, "\\(").replace(/\)/g,
        ...
        if (a = a && a.timing) {
            ...
            if (c)
                for (b = [a.domainLookupEnd - a.domainLookupStart, a.connectEnd - a.connectStart, a.responseStart - a.requestStart, a.responseEnd - a.responseStart, a.fetchStart - c, a.redirectEnd - a.redirectStart, a.redirectCount], b.push(a.domInteractive && a.domLoading ?
                        a.domInteractive - a.domLoading : null), b.push(a.domContentLoadedEventStart && a.domContentLoadedEventEnd ? a.domContentLoadedEventEnd - a.domContentLoadedEventStart : null), b.push(a.domComplete ? a.domComplete - c : null), b.push(a.loadEventStart ? a.loadEventStart - c : null), b.push(a.loadEventStart && a.loadEventEnd ? a.loadEventEnd - a.loadEventStart : null), b.push(a.domContentLoadedEventStart ? a.domContentLoadedEventStart - c : null), a = 0; a < b.length; a++) c = b[a], null !== c && (0 > c || 36E5 < c) && (b[a] = null)
        }
        return b
    }
    ...
    function Na(a) {
        var b = [],
            ...
            d = qa();
        if (c)
            for (var e = 0, g = c.length; e < g; e++) null === d[e] ? b.push(d[e]) : b.push(c[e] === d[e] ? "" : d[e]);
        else b = d;
    ...
    function Pa(a) {
        var b = f.referrer || "";
        if (RegExp("^https?://" + x.host + "/").test(b)) return !1;
        for (var c = a.patterns, d = 0; d < c.length; d++)
            if (b.match(RegExp(c[d], "i"))) {
                var e = a.params || [];
                if (e.length)
                    for (var g = Q((RegExp.$1 || "").replace(/\+/g, "%20")), n = 0; n < e.length; n++) {
                        if (g == Q(e[n])) return !0
                    } else return !0
            }
        return !1
        ...
        if (a && "string" != typeof a && a.length)
            for (var d = 0; d < a.length; d++) {
                var e = a[d].selector,
                    ...
                    e = e.slice(1);
                if ("#" == n) {
                    if (n = f.getElementById(e)) c = !0, b && R.unshift([n,
                        n.innerHTML
                    ]), n.innerHTML = g
                } else if ("." == n)
                    for (n = l.getElementsByClassName(e), e = 0; e < n.length; e++) {
                        var c = !0,
                            h = n[e],
                            k = g;
    ...
    function sa() {
        for (var a = 0; a < R.length; a++) R[a][0].innerHTML = R[a][1]
    }
    ...
    function Qa(a, b) {
        ...
        c && (c = -1 < c.indexOf(";") ? Q(c) : Ra(c.replace(/[-*_]/g,
            function(a) {
                return {
                    "*": "+",
                    "-": "/",
    ...
    function Ra(a) {
        ...
        do {
            ...
            if (0 > b || 0 > c || 0 > e || 0 > g) return null;
            d = b << 18 | c << 12 | e << 6 | g;
            b = d >> 16 & 255;
            c = d >> 8 & 255;
            d &= 255;
        ...
        a = h;
        e = "";
        for (b = h = f = g = 0; g < a.length;) f = a.charCodeAt(g), 128 > f ? (e += String.fromCharCode(f), g++) : 191 < f && 224 > f ? (h = a.charCodeAt(g + 1), e += String.fromCharCode((f & 31) << 6 | h & 63), g += 2) : (h = a.charCodeAt(g + 1), b = a.charCodeAt(g + 2),
            e += String.fromCharCode((f & 15) << 12 | (h & 63) << 6 | b & 63), g += 3);
        return e
    }
    ...
    function Sa(a, b, c, d, e, I) {
        ...
        function m(a, b) {
            for (b = Math.max(0, b | 0); 127 < b;) h.mergeArrays(a, [b & 127 | 128]), b >>= 7;
            h.mergeArrays(a, [b])
        }
        ...
        function x(a, b, c, d, e, g) {
            ...
            /^mouse(up|down)|click$/.test(b) && (a = e || g, p(c, 2 > a ? Ka : a == (e ? 2 : 4) ? Ma : La));
            return c
        }
        ...
        function U(a, b) {
            var c, d;
            0 == b.length ? d = c =
                "" : 100 >= b.length ? (c = b, d = "") : 200 >= b.length ? (c = b.substr(0, 100), d = b.substr(100)) : (c = b.substr(0, 97), d = b.substr(b.length - 97));
            var e = [];
            p(e, Fa);
            m(e, a);
            r(e, c);
        ...
        function Y(a) {
            var b = a[A];
            if (!b || 0 > b || !/^INPUT|SELECT|TEXTAREA$/.test(a.nodeName) || !a.form || l.classNameExists(a.form, "-metrika-noform")) return null;
            ...
            for (var e = -1, g = a.form.elements, f = g.length,
                    h = 0, n = 0; h < f; h++)
                if (g[h].name == a.name) {
                    if (g[h] == a) {
                        e = n;
            ...
            if (a[A]) a: {
                ...
                if (0 < c) {
                    ...
                    var e = va[c],
                        g = a[0] + "x" + a[1],
                        f = a[2] + "x" + a[3];
                    g != e.pos && (e.pos = g, p(d, ka), m(d, b), m(d, c), m(d, a[0]), m(d, a[1]));
                    f != e.size && (e.size = f, p(d, la), m(d, b), m(d, c), m(d, a[2]), m(d, a[3]));
                    if (d.length) {
                        a = d;
                        break a
                    }
                ...
                Va++;
                if (a.nodeName)
                    if (c = +a[A], !isFinite(c) || 0 >= c) b = null;
                    else {
                        var d = Qa,
                            e = 0,
                            h = l.getElementParent(a),
                            g = h && h[A] ? h[A] : 0;
                        0 > g && (g = 0);
                        ...
                        var q;
                        b: {
                            q = l.getElementChildren(l.getElementParent(a), a.tagName);
                            for (var S = 0; S < q.length; S++)
                                if ((!q[S].id || "string" != typeof q[S].id) && l.calcAttribChecksum(q[S]) == k && l.calcTextChecksum(q[S]) == h) {
                                    q = !0;
                                    break b
                                }
                            q = !1
                        ...
                        q &&
                            (d |= nb, b = l.calcChildrenChecksum(a));
                        q = [];
                        p(q, W);
                        m(q, c);
                        p(q, d);
                        ...
                        n ? p(q, n) : w(q, f);
                        I && m(q, I);
                        d & lb || (m(q, v[0]), m(q, v[1]), m(q, v[2]), m(q, v[3]));
                        d & mb && w(q, a.id);
                        h && s(q, h);
                        d & nb && s(q, b);
                        p(q, e);
        ...
        function J(a) {
            ...
            if (b && "SCROLLBAR" != b.nodeName) {
                ...
                q(x, [t(), a.type, b, B.getPos(a), a.which, a.button])
            }
        }
        ...
        function wa(a) {
            ...
            a: {
                ...
                if ("string" == typeof b) {
                    ...
                    c && Wa(c) || c && (/(?:^|\s)-metrika-nokeys(?:\s|$)/.test(c.className) || l.getElementsByClassName("-metrika-nokeys", c).length) || b == Xa || (Xa = b, q(U, [t(), b]))
                }
            }
        }
        ...
        function xa() {
            var a = l.getDocumentScroll(),
                b = S();
            b - qb < ba || 10 > Math.abs(a[0] - $a[0]) && 10 > Math.abs(a[1] - $a[1]) || (qb = b, $a = a, q(D, [t(), a]))
        }
        ...
        function rb(a) {
            ...
            if (a.localId) {
                if (b = ab[a.localId], !b || 10 > Math.abs(c[0] - b[0]) && 10 > Math.abs(c[1] - b[1])) return
            } else {
                for (; ab[b];) b = Math.random();
                a.localId =
                    b
            }
            ab[a.localId] = c;
        ...
        function bb() {
            q(E, [t(), l.getViewportSize(), l.getDocumentSize()])
        }
        ...
        function wb(a, b, c) {
            a = B.getTarget(a);
            Wa(a) || /(?:^|\s)-metrika-nokeys(?:\s|$)/.test(a.className) || (z(a), q(K, [t(), b, c, a]))
        }
        ...
        function xb(a) {
            ...
            if ({
                    ...
                    144: 1,
                    145: 1
                }[b] || 112 <= b && 123 >= b || 96 <= b && 105 >= b || c & za) 19 == b && (c & ~za) == cb && (b = 144), wb(a, b, c | za), db = !1, h.setTimeout(function() {
                db = !0
        ...
        function eb() {
            gb || (gb = !0, Xa && q($, [t()]), h.setTimeout(function() {
                    gb = !1
                },
                1))
        }
        ...
        function Aa(a) {
            if ((a = B.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName)) {
                if (a[A]) z(a);
                    ...
                    var b = a.form;
                    if (b)
                        for (var b = b.elements, c = b.length, d = 0; d < c; d++) /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b[d].tagName) && !b[d][A] && z(b[d]);
                    else z(a)
                }
                q(Cb, [t(), a])
            }
        ...
        function F(a) {
            (a = B.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName) &&
                (z(a), q(Db, [t(), a]))
        }
        ...
        function Q(a) {
            ...
            if (!l.classNameExists(a, "-metrika-noform") && "FORM" == a.nodeName) {
                for (var b = a.elements, c = 0; c < b.length; c++) l.isEmptyField(b[c]) || z(b[c]);
                q(N, [t(), a], !0)
            }
        }
        ...
        function R(a) {
            ...
            if (a.touches && a.touches.length) {
                ...
                if (b && b != f) {
                    z(b);
                    for (var c = 0; c < a.touches.length; c++) q(x, [t(), "touch", b, [a.touches[c].pageX, a.touches[c].pageY], 0, 0])
                }
            }
        }
        ...
        function Z(a) {
            ...
            if (b) {
                ...
                c && (z(b), q(C, [t(), b, B.getPos(a), c]))
            }
        }

        function T(a) {
            (a = B.getTarget(a)) && "BODY" == a.tagName && ca.append([], !0)
        }
        var ca = new Bb({
                protocol: a,
                counterId: b,
        ...
        if ("MetrikaPlayer" != g.name) {
            ...
            k.on(f, "mouseup", wa);
            k.on(g, "scroll", xa);
            if ("onmousewheel" in f) k.on(f, "mousewheel", Z);
            else k.on(f, "wheel", Z);
            k.on(g, "beforeunload", ya);
            if (!Eb) k.on(g, "unload", ya);
            k.on(g, "resize", bb);
            k.on(f, "keydown", xb);
            k.on(f, "keypress", yb);
            k.on(f, "copy", eb);
            k.on(f, "touchmove,touchstart",
                R);
            if (f.body) k.on(f, "mouseleave", T);
            f.attachEvent && !g.opera ? (k.on(f, "focusin", zb), k.on(f, "focusout", Ab)) : (k.on(g, "focus", hb), k.on(g, "blur", ia), k.on(f, "blur", ia));
            f.addEventListener ? (k.on(f, "scroll", rb), k.on(f, "focus", Aa), k.on(f, "blur", F), k.on(f, "change", V), k.on(f, "submit", Q)) : f.attachEvent && (k.on(f, "focusin", Aa), k.on(f, "focusout", F), function() {
            ...
            I.uploadPage = G(function(d) {
                ...
                var n = g.XMLHttpRequest ? new g.XMLHttpRequest : new ActiveXObject("Msxml2.XMLHTTP"),
                    v = l.getDocumentCharset(),
                    h = "text/html" + (v ? ";charset=" + v : ""),
                    I = new Fb({
                        protocol: a,
                        counterId: b,
                        counterType: c
                    });
                if ("html" == d) return d = RegExp("<script [^>]*?//mc\\.yandex\\.ru/watch/.*?\x3c/script>", "gi"), I.sendContent(l.getDocumentHTML().replace(d, ""), h, e, Ba, Ca), !0;
                n && (n.open("get", u().href, !0), n.onreadystatechange = G(function() {
                    4 == n.readyState && I.sendContent(n.responseText, n.getResponseHeader("content-type"),
                        e, Ba, Ca)
                }, "updatePage.1"), n.overrideMimeType && v && n.overrideMimeType(h), n.send(null));
                return !0
            }, "uploadPage")
        }
        return {
            ...
            stop: function() {
                ...
                k.un(g, "blur", ia);
                k.un(f, "blur", ia);
                f.removeEventListener ? (k.un(f, "scroll", rb), k.un(f, "focus", Aa), k.un(f, "blur", F), k.un(f, "change", V), k.un(f, "submit", Q)) : f.detachEvent && (k.un(f, "focusin", Aa), k.un(f, "focusout", F), function() {
                    for (var a = f.getElementsByTagName("form"), b = 0; b < a.length; b++) {
                ...
                (function() {
                    for (var a =
                            f.getElementsByTagName("form"), b = 0; b < a.length; b++) a[b][Da] && (a[b].submit = a[b][Da])
                })()
            },
            uploadPages: function(a, b) {
                function c() {
                    ...
                    k.un(g, "load", c);
                    for (var d = a.split(/\n/), e = u().href, h = /regexp:/, n = 0; n < d.length; n++) {
                        var v = d[n];
                        if (v)
                            if (h.test(v)) {
                                v = kb(v.replace(h, ""));
    ...
    var ib = !1,
        ...
        l = {
            ...
            getDocumentScroll: function() {
                return [g.pageXOffset || f.documentElement && f.documentElement.scrollLeft || f.body && f.body.scrollLeft || 0, g.pageYOffset || f.documentElement && f.documentElement.scrollTop || f.body && f.body.scrollTop ||
                    0
                ]
            },
    ...
    l.getElementsByClassName = function(a, b) {
        b = b || f;
        for (var c = b.getElementsByTagName("*"), d = [], e = 0; e < c.length; e++) l.classNameExists(c[e], a) && d.push(c[e]);
        return d
    };
    l.getDocumentTitle = function() {
        var a = f.title;
        "string" != typeof a && (a = (a = f.getElementsByTagName("title")) && a.length ?
            a[0].innerHTML : "");
        return a
    };
    var B = {
        ...
        getMouseButton: function(a) {
            return a.which || a.button == F ? a.which : a.button & 1 ? 1 : a.button & 2 ? 3 : a.button & 4 ? 2 : 0
        }
    };
    h.mixin = function(a) {
        for (var b = 1; b < arguments.length; b++)
    ...
    var k = H.inherit({
        ...
        on: function(a, b, c, d, e) {
            ...
            for (var f = b.split(","), h = 0; h < f.length; h++) {
                ...
                a.addEventListener ? a.addEventListener(k, l, e) : a.attachEvent && a.attachEvent("on" +
                    k, l)
            }
        },
        ...
        switch (a.constructor) {
            ...
            case String:
                return '"' + a.replace(/\\/g, "\\\\").replace(/"/g, '\\"').replace(/\n/g,
                    "\\n").replace(/\r/g, "\\r") + '"';
            case Array:
                for (var b = [], c = 0, d = a.length; c < d; c++) b[b.length] = h.toJSON(a[c]);
                return "[" + b.join(",") + "]";
            case Object:
                b = [];
                for (c in a) a.hasOwnProperty(c) && a[c] !== F && (b[b.length] = h.toJSON(c) + ":" + h.toJSON(a[c]));
                return "{" + b.join(",") + "}";
            default:
                return "null"
        }
    ...
    var aa = H.inherit({
            ...
            set: function(a, b) {
                if (this.isEnabled()) try {
                    !b || b && h.isArray(b) &&
                        !b.length ? this.remove(a) : this._ls.setItem(this._getLsKey(a), h.toJSON(b))
                } catch (c) {}
            },
            get: function(a) {
                if (this.isEnabled()) try {
    ...
    C.inherit({
        ...
        request: function(a, b, c, d) {
            "function" == typeof D.sendBeacon ? (b = this._splitParams(b), c.call(d, D.sendBeacon(this._buildUrl(a, b.get), ja.stringify(b.post)))) : c.call(d, !1)
        }
    });
    ...
    h.setTimeout = function(a, b, c) {
        return h.getNativeFunction("setTimeout")(G(a, c || "setTimeout"), b)
    };
    var K = C.inherit({
        id: "XHR",
        request: function(a, b, c, d) {
    ...
    var T = C.inherit({
            ...
            request: function(a, b, c, d) {
                ...
                f.style.top = "-99999px";
                var k = ['<iframe name="', g, '"></iframe>', '<form action="', this._buildUrl(a, b.get), '" method="post" target="',
                    g, '" enctype="', this.enctype, '">'
                ];
    ...
    var U = r.inherit({
        ...
        _sendSavedRequest: function(a, b, c, d, e) {
            ...
            if ("process" == f) g.Ya._metrika.firstReqCallbacks = h.mergeArrays(g.Ya._metrika.firstReqCallbacks || [], [
                [this, arguments]
            ]);
            else {
                f || (g.Ya._metrika.firstReqStatus = "process");
                f = {};
                this.counterType && (f["cnt-class"] =
                    this.counterType);
                h.mixin(f, b);
                ...
                return U.superclass.send.call(this, k, f, function() {
                    ...
                    if (b)
                        for (var c =
                                0; c < b.length; c++) b[c][0]._sendSavedRequest.apply(b[c][0], b[c][1]);
    ...
    U.retransmit = function() {
        ...
        h.forEachKey(b, function(a, b) {
            ...
            b.ghid && b.ghid != Ya._globalMetrikaHitId && b.time && b.time + 864E5 > +new Date &&
                2 >= b.browserInfo.rqnl && (new U({
                    protocol: b.protocol,
                    host: b.host,
                    resource: b.resource,
    ...
    var P = {
            ...
            tailSafe: "*-_",
            encode: function(a, b) {
                for (var c = (P.abc + (b ? P.tailSafe : P.tail)).split(""), d = a.length, e = [], f = d - d % 3, g, k = 0; k < f; k += 3) g = (a[k] << 16) + (a[k + 1] << 8) + a[k + 2], h.mergeArrays(e, [c[g >> 18 & 63], c[g >> 12 & 63], c[g >> 6 & 63], c[g &
                    63]]);
                switch (d - f) {
                    case 1:
                        g = a[f] << 4;
                        h.mergeArrays(e, [c[g >> 6 & 63], c[g & 63], c[64], c[64]]);
                        break;
                    case 2:
                        g = (a[f] << 10) + (a[f + 1] << 2), h.mergeArrays(e, [c[g >> 12 & 63], c[g >> 6 & 63], c[g & 63], c[64]])
                }
                return e.join("")
            }
        },
    ...
    h.throttle = function(a, b, c, d) {
        ...
        return function() {
            ...
            e || function() {
                e = null;
                g && (a.apply(c || f, g), g = null, e = h.setTimeout(arguments.callee, b, d))
            }()
        }
    };
    var Ea = H.inherit({
    ...
    var w = {
        ...
        getSilverlightVersion: function() {
            if (!w._silverlightVersion)
                ...
                } catch (d) {} else if (a = D.plugins["Silverlight Plug-In"]) w._silverlightVersion = a.description;
        ...
        getFlashVersion: function() {
            if (!w._flashVersion) {
                ...
                if ("undefined" != typeof a.plugins &&
                    ...
                    b && (a = a.mimeTypes, "undefined" == typeof a || !a["application/x-shockwave-flash"] || a["application/x-shockwave-flash"].enabledPlugin) && (w._flashVersion = b.replace(/([a-zA-Z]|\s)+/, "").replace(/(\s+r|\s+b[0-9]+)/, "."))
                } else if ("undefined" != typeof g.ActiveXObject) try {
                    if (b = new ActiveXObject("ShockwaveFlash.ShockwaveFlash")) {
                        var c = b.GetVariable("$version");
                        c && (w._flashVersion = c.split(" ")[1].replace(/,/g, ".").replace(/[^.\d]/g,
                            ""))
                    }
                } catch (d) {}
            }
        ...
        getLanguage: function() {
            return (g.navigator && (D.language || D.browserLanguage) || "").toLowerCase()
        },
    ...
    w.getFingerPrint = function() {
        ...
        if (D.plugins && D.plugins.length)
            for (var b = 0; b < D.plugins.length; b++) {
                var c = D.plugins[b];
                h.mergeArrays(a, [c.name, c.version,
                    c.description, c.filename
                ])
            }
        if (D.mimeTypes && D.mimeTypes.length)
            for (b = 0; b < D.mimeTypes.length; b++) c = D.mimeTypes[b], h.mergeArrays(a, [c.type, c.description, c.suffixes]);
    ...
    var ba = U.inherit({
        ...
        sendGoal: function(a, b) {
            if (!/[\/&=?#]/.test(a)) {
                var c = a ? "goal://" + u().hostname + "/" + encodeURIComponent(a) : u().href,
                    d = l.getDocumentTitle(),
                    e = a ? u().href : f.referrer;
        ...
        _hitExt: function(a, b, c, d, e, f, k,
            ...
            if ("MetrikaPlayer" != g.name) {
                ...
                p("page-ref", h.trim(c, la));
                p("page-url", h.trim(a, la)); - 1 != u().hostname.search(/(?:^|\.)(?:ya|yandex|narod|narod2)\.(?:\w+|com\.\w+)$/) ? p("ut", ka) : "undefined" != typeof e.ut && p("ut", h.trim(e.ut, Gb));
                if (d)
                    if (a = h.toJSON(d), this.trimParams && a.length > Hb) var w = !0;
                    else p("site-info", a);
                e.saveRef && (V = c);
        ...
        _getTechInfo: function(a, b, c, d, e, f, k, r, t) {
            function s(a, b) {
                a && b && (m[a] = b)
            }
            ...
            d = d || N.getTimestamp();
            e = e || N.getTimezone();
            s("j", w.getJavaEnabled() ? "1" : "");
            W && s("s", W.width + "x" + W.height + "x" + (W.colorDepth || W.pixelDepth));
            g.devicePixelRatio && s("sk",
                g.devicePixelRatio);
            s("f", w.getFlashVersion());
            s("l", w.getSilverlightVersion());
            s("fpr", w.getFingerPrint());
            ...
            e = ["va", "vt", "sn", "sa", "he"];
            b.nb && e.push("cl");
            for (d = 0; d < e.length; d++) f = e[d], s(f, b[f]);
            c = new aa({
                counterId: c
            });
            c.isEnabled() && (d = c.getStorageId(), (e = c.get("reqNum")) ? e++ : e = 1, c.set("reqNum", e), c.get("reqNum") == e ? (s("ls", d), s("rqn", e)) : (c.remove("reqNum"), c.clearStorageId(), 1 < e && (s("ls", d), s("rqn", 0))));
            s("rn", h.random());
            s("hid", k);
            s("ds", Na(t));
            t._firstPaint || (t._firstPaint = Oa(), s("fp", t._firstPaint));
            if (r) {
    ...
    var X = H.inherit({
            ...
            logParams: function(a) {
                Math.random() <
                    this.sampling && this._sender.sendHit(x.href, "", "", a)
            }
        }),
        Ib = U.inherit({
            resource: "webvisor",
            ...
            sendPacket: function(a, b, c, d, e, f, k, l) {
                ...
                var t = P.encode(a, !0);
                0 == t.indexOf("AAAAAAAAADw") && g.Error && "string" == typeof Error().stack && (new X({
                    sampling: 0.1
    ...
    var da = {
            log: function() {
                g.console && console.log && (-1 < x.href.indexOf("_ym_debug=1") || g._ym_debug) && console.log.apply(console, arguments)
            }
        },
        Jb = U.inherit({
            resource: "clmap",
        ...
        Kb = H.inherit({
            ...
            _initComponent: function() {
                ...
                this._ignoreTags = [];
                if (this.ignoreTags)
                    for (var a = 0; a < this.ignoreTags.length; a++) this.ignoreTags[a] && h.mergeArrays(this._ignoreTags, [String(this.ignoreTags[a]).toUpperCase()]);
                this._cacheTags = {};
            ...
            _handler: function(a) {
                ...
                if (this._isTrackingClick(a)) {
                    ...
                    var b = l.getElementSize(a.el),
                        ...
                        b = ["rn", h.random(), "x", Math.floor(65535 * (a.pos[0] - c[0]) / (b[0] || 1)), "y", Math.floor(65535 * (a.pos[1] - c[1]) / (b[1] || 1)), "t", Math.floor((a.time -
                            this.startTime) / 100), "p", this._getElPath(a.el)];
                    L = 4;
                    c = u().href;
            ...
            _isTrackingClick: function(a) {
                if (g.ymDisabledClickmap || "MetrikaPlayer" == g.name) return !1;
                var b = a.el.tagName;
            ...
            _getElPath: function(a) {
                for (var b =
                        ""; a && a.parentNode && "BODY" != a.tagName && "HTML" != a.tagName;) b += this._cacheTags[a.tagName] || "*", b += l.getElementNeighborPosition(a) || "", a = a.parentNode;
    ...
    N.getTimestamp = function() {
        for (var a = new Date, a = [a.getFullYear(), a.getMonth() + 1, a.getDate(), a.getHours(), a.getMinutes(), a.getSeconds()], b = "", c = 0; c < a.length; c++) b += h.pad(a[c]);
        return b
    };
    ...
    var Ha = H.inherit({
        ...
        Lb = ba.inherit({
            transports: [r],
            trimParams: !0,
            sendHit: function(a, b, c, d, e, f, g, h, k, l, p) {
                var m = {};
                f && (m.vc = f);
                g && (m.pr = 1);
                this._hitExt(a, b, c, d, e, m, h, k, l, p)
            }
        }),
        R = [];
    g.Ya = g.Ya || {};
    ...
    var x = u(),
        ...
        Ia = 50,
        Mb = 15E3,
        Ja = RegExp("\\.(3gp|7z|aac|ac3|acs|ai|avi|ape|apk|asf|bmp|bz2|cab|cdr|crc32|css|csv|cue|divx|dmg|djvu?|doc(x|m|b)?|emf|eps|exe|flac?|flv|iso|swf|gif|t?gz|jpe?g?|js|m3u8?|m4a|mp(3|4|e?g?)|m4v|md5|mkv|mov|msi|ods|og(g|m|v)|pdf|phps|png|ppt(x|m|b)?|psd|rar|rss|rtf|sea|sfv|sit|sha1|svg|tar|tif?f|torrent|ts|txt|vob|wave?|wma|wmv|wmf|webm|xls(x|m|b)?|xpi|g?zip)$",
            "i"),
        Nb = +new Date,
        ma, ea;
        ...
        return G(function() {
            function r(v) {
                ...
                if (!d && !q) {
                    ...
                    var z = new Z({
                        ...
                        J = z.read("visorc");
                    "b" != J && "w" != J && (J = "");
                    if (!z.isEnabled() || ga("opera mini")) J = "b";
                    ma = +new Date;
                    var q = new Lb({
                            protocol: $,
                            counterType: c,
                    ...
                    q.sendHit(x.href, l.getDocumentTitle(), f.referrer, b, p, J, v, Ca, Ba, function(a) {
                        ea || (ea = +new Date);
                        a = a || {};
                        var b = a.webvisor || {};
                        if (N) {
                            var c = +b.recp;
                            if (!isFinite(c) || 0 > c || 1 < c) J = "w";
                            J || (J = E % 1E4 / 1E4 < c ? "w" : "b");
                            z.create("visorc", J, 30);
                            "w" == J ? (N.start(), c = b.arch_type, (b = b.urls) && c && N.uploadPages(b, c)) : N.stop()
                        }
                        b = a.mp2;
                        a = e;
                        z.erase("mp2_substs");
                        if (b) {
                            b: if ((c = b.conditions) && c.length)
                                    for (var d = 0; d < c.length; d++) {
                                        var v;
                                        if ("ref" == c[d].type) v = Pa(c[d]);
                                        else if (v = "adv" == c[d].type) {
                                            var q = c[d],
                                                l = Ya._metrika.counter._directCampaign,
                                                m = q.ServiceNamePattern,
                                                n = q.RefererPattern;
                                            v = l ? q.direct_orders : q.direct_camp;
                                            var s = f.referrer,
                                                p = x.search,
                                                p = p && p.replace(/^\?/, ""),
                                                w = {};
                                            ...
                                            for (var p = Qa(x.search,
                                                    x.hash), t = {}, r = ["source", "medium", "campaign", "term", "content"], u = 0; u < r.length; u++) w["utm_" + r[u]] && (t[r[u]] = w["utm_" + r[u]]);
                                            u = l ? "direct.yandex.ru" : p && p.service || t.source;
                                            r = !1;
                                            if (!r && m && m.length)
                                                for (var y = 0; y < m.length; y++)
                                                    if (RegExp(m[y], "i").test(u)) {
                                                        r = !0;
                                                        break
                                                    }
                                            if (!r && n && n.length)
                                                for (m = 0; m < n.length; m++)
                                                    if (RegExp(n[m], "i").test(s)) {
                                                        r = !0;
                                                        break
                                                    }!r && q.google_adwords && w.gclid && (r = !0);
                                            !r && q.yandex_direct && w.yclid && (r = !0);
                                            if (r && v && v.length && (r = !1, q = l || p && p.campaign || t && t.campaign))
                                ...
                                c = z.read("mp2_track");b = b.substs && b.substs[c];c && b ? (z.create("mp2_substs", h.toJSON(b)), b = ra(b), a.params("__ym", b ? "mp_trackid" : "mp_trackid_bad", c)) : sa()
                        } else sa();
                ...
                C();
                y && (y.enableAll ? (n(!0), s(!0), m()) : (y.clickmap && s(y.clickmap), y.trackLinks && n(y.trackLinks), y.accurateTrackBounce && m(y.accurateTrackBounce), y.ad && ad()), (y.useDataLayer || 0.01 > Math.random()) && new Ha({
                    counter: e
                }));
            ...
            function t(a) {
                ...
                if (b) {
                    ...
                    if (Ja.test(f) || Ja.test(d) || pa(d, P) || pa(f, P)) c = !0;
                    var m = l.classNameExists(b, "ym-disable-tracklink"),
                        f = l.classNameExists(b, "ym-external-link");
                    m || (m = {
                        ln: !0,
                        dl: c
                    }, f ? (m.delay = k(), h(m)) : La(u().hostname, b.hostname) ? c && (m.ln = !1, m.delay = k(), h(m)) : d && -1 != d.search(/^ *(data|javascript):/i) || (m.ut = ka, m.delay = k(), h(m)))
                }
            }
            ...
            function p(a, b) {
                ...
                function m(a) {
                    for (var b = 0; b < x.length; b += 3)
                        if (a) k.on(x[b], x[b + 1], x[b + 2]);
                        else k.un(x[b], x[b + 1], x[b + 2])
                }
                var n = !1,
                    p = !1,
                    r = !0,
                    ...
                    u = null,
                    y = !1;
                if (w.isIE()) h.setTimeout(a, b, "trackUserTime");
                else {
            ...
            function m(b) {
                ...
                if (!e._isAccurateTrackBounce) {
                    ...
                    ((c = c.get("lastHit")) && (!d || d < c - 18E5) || !Ma(f.referrer, u().href) || 0.1 > Math.random()) && p(function() {
                        e.notBounce()
                    }, b)
                }
            }
            ...
            function B(a) {
                if (!1 ===
                    a) Y && ("onhashchange" in g ? k.un(g, "hashchange", H) : h.clearTimeout(W), Y = !1);
                else if (a = H, !Y) {
            ...
            function H() {
                ...
                M.sendAjaxHit(u().href, l.getDocumentTitle(), T, a);
                R = u().href
            }
            var E = Math.round(1073741824 * Math.random());
            Ya._metrika.counterNum++;
            var K = Ya._metrika.counterNum,
                F, L = "",
                O = $,
                R = V = x.href,
                T = "",
            ...
            "object" == typeof a &&
                (y = a, d = a.defer, L = a.ut, c = a.type, b = a.params, O = a.onlyHttps ? "https:" : $, a = a.id);
            a = a || 0;
            /^\d+$/.test(a) || (a = 0);
            c = c || 0;
            F = a + ":" + c;
            ...
            e.reachGoal = G(function(b, c) {
                da.log("Reach goal. Counter: " +
                    a + ". Goal id: " + b + ". Params: ", c);
                M.sendGoal(b, c);
                return !0
            }, "counter.reachGoal");
            ...
            if (a)
                if ("prerender" == f.webkitVisibilityState) {
                    ...
                    var X = function() {
                        "prerender" != f.webkitVisibilityState && (k.un(f, "webkitvisibilitychange", X), r(!0))
                    };
    ...
    if (g.performance &&
        ...
        K = performance.getEntries();
        O = {};
        for (r = 0; r < K.length; r++) {
            var E = K[r],
                na = E.name.replace(/^https?:\/\//, "").split("?")[0],
                Ob = h.fnv32a(na);
            C[Ob] && !O[na] && 0 < E.duration && (O[na] = {
    ...
    for (r = 0; r < C.length; r++)
        if (K = C[r] + "map", -1 != x.href.search("ym_playback=" + K)) {
            ua($ + "//metrika.yandex.ru/js/" + K + "/_loader.js");
            break
        }
