...
If (isset($_POST["additionalCharges"])) {
     ...
     $hash = hash("sha512", $retHashSeq);
       ...
       if ($hash != $posted_hash) {
        $status_succ = "Sorry!";
         $message_succ= "Invalid Transaction. Please try again";
       }
     else {
             
          $fgmembersite->OrderSubmit();   
          $status_succ = "Thank You!";
          $message_succ = "Your order status is ". $status .".<br>Your Transaction ID for this transaction is ".$txnid.".</h4><br>We have received a payment of Rs. " . $amount . ". Your order will soon be shipped.";
            ...
            <div class="container cl404" style="min-height:500px;padding-top:10px">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                           ...
                           <div class="col-md-9 col-md-offset-2 error-box" style="padding-top:80px">
                               <div class="col-md-12 " >
                                    <p class="error-msg" style="font-size:3em;,margin:0em"><?php echo $status_succ ?></p>
                                    <br><h1><?php echo $message_succ ?></h1>
                                </div>
                                <div class="col-md-12 ">
            ...
            <div class="footer-sub">
                <div class="container">
                    <div class="row" >
                        ...
                        <div class="col-md-6" align="center">
                             <a href="http://accelerate.businessworld.in/"><img class="img-responsive" src="img/home/BW.png"></a>
                        </div>
