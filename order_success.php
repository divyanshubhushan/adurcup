...
$fgmembersite->CODOrderSubmit();   
          $status_succ = "Thank You!";
          $message_succ = "You have successfully shopped using Cash on Delivery. <br><h4><br>We are expecting a payment of Rs. " . $amount . ". Your order will soon be shipped. </h4>";
