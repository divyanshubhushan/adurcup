...
function setCookie(e) {
    $.cookie("cart", JSON.stringify(e), { path: '/', domain: 'www.adurcup.com' })
}
...
function updateCart() {
    ...
    if (typeof e == "undefined") {
        ...
        for (var f in e) {
            ...
            if (++o > a) continue;
            var l = $('<li> 							<div class="item clearfix" data-product-id="' + e[f].id + '"> 								<button type="button" class="close" aria-hidden="true">×</button> 								<a href="' + e[f].thumbnail + '" data-toggle="lightbox" class="entry-thumbnail"> 									<img src="' + e[f].thumbnail + '" alt="' + e[f].title + '" /> 								</a> 								<h5 class="entry-title"><a href="' + e[f].url + '">' + e[f].title + '</a></h5> 								<span class="entry-price">' + e[f].qty + " x " + e[f].price + "</span> 							</div> 						</li>");
            l.appendTo(n);
        ...
        if (o == 0) {
            $.removeCookie("cart", { path: '/', domain: 'www.adurcup.com' });
            updateCart();
            return
        }
