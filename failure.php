       ...
       if ($hash != $posted_hash) {
        $status_succ = "Sorry!";
         $message_succ= "Invalid Transaction. Please try again";
          ...
          $status_succ = "Sorry!";
          $message_succ = "Your order status is ". $status .".<br>Your Transaction ID for this transaction is ".$txnid.".<br>You may try making the payment by clicking the link below.";
