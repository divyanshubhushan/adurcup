        ...
        <main id="main-content" role="main" style="margin-top:70px">
                ...
                <div  align="center">
                        ...
                        <p style="font-size:18px;margin-top:-32px;color:#999;background:#fff;width:200px">Recommendations</p>
                         <div class="col-md-10 col-md-offset-1" style="height:70px;">
                             <div class="col-md-3" id="tobecovered">
                                <img src="img/1920/blue.jpg" class="cover">
                                <p align="center">Hello World</p>
                             </div>
                             <div class="col-md-3" id="tobecovered" style="margin:0 15px">
                                <img src="img/1920/blue.jpg" class="cover">
                                <p align="center">Hello World</p>
                             </div>
                             <div class="col-md-3" id="tobecovered" style="float:right;margin:0 15px">
                                <img src="img/1920/blue.jpg" class="cover">
                                <p align="center">Hello World</p>
                             </div>
                             <div class="col-md-3" id="tobecovered" style="float:right">
                                <img src="img/1920/blue.jpg" class="cover">
                                <p align="center">Hello World</p>
                             </div>
                         </div>
