...
<body id="page-top">
    ...
    <div id="page-wrapper">
		...
		<!-- SITE MAIN CONTENT -->
		<main id="main-content" role="main" style="padding-top:40px;">
			...
			<div class="container">
				<div class="row">
					...
					<section class="col-xs-12 col-md-12">
                                ...
                                <div class="col-md-8" style="padding: 0 0 20px 0 ; border-right:1px solid #d9d9d9;">
                                    <h2 class="uppercase text-bold" >
                                     <span class="text-xs"><i class="iconfont-envelope" style="padding-right:10px"></i>Send us a message</span>
                                      </h2>
                                ...
                                <div class="col-md-4" style="padding-left:30px">
                                    <h2 class="uppercase text-bold" >
                                     <span class="text-xs"><i class="iconfont-phone" style="padding-right:10px"></i>Call Us Directly</span>
                                    </h2>
                                    <p class="text-bold" style="font-size:16px" ><i class="iconfont-mobile" style="padding-right:10px"></i>+918800222769 &nbsp;  | &nbsp; <i class="iconfont-mobile" style="padding-right:10px"></i>+918826076096 </p>
					...
					<section class="section" style="padding-top:20px;margin-bottom:40px;border-top:1px solid #666;">
						<div style="margin:20px 0 0 0;">
								<div style="width:30px; height:30px;">
		                            <img src="./images/comma1.png">
		                        </div>
		                        <div align="center" style="padding:0 20px 0 25px;font-size:20px;font-style:italic;">
		                        	Coming together is a beginning. Keeping together is progress. Working together is success.
		                        </div>
		                        <div style="width:30px; height:30px;float:right">
		                            <img src="./images/comma2.png">
		                        </div>
		                        <div align="center" style="padding:20px 20px 0 0;font-size:18px;font-style:italic;">
		                        	- Henry Ford
		                        </div>
							</div>	
						<div class="clearfix"></div>
					...
					<!-- <section class="section" style="padding:20px 0 10px 0;border-top:1px solid #d9d9d9;">
						<section class="col-xs-12 col-md-12" align="center" style="padding:10px 0 20px 0;">
							<div class="row">
								<h3 align="center" style="color:#666">Our Superhero</h3>
								<div align="center" style="padding-bottom:20px">
									<div class="team-member">
										<img alt="" class="img-responsive img-circle" src="images/ashu.jpg" style="height:110px;width:100px;">
										<h4 style="margin:5px 0 0 0;color:#08c">Ashu Agrawal</h4>
										<p>
											Mentor
					...
					<!-- <section class="section" style="padding:10px 0 20px 0;border-top:1px solid #d9d9d9;">
						<section class="col-xs-12 col-md-12" style="padding:10px 0 20px 0;">
								<h3 align="center" style="color:#666">Our Heroes</h3>
								<div class="col-sm-2 col-sm-offset-4" align="center" style="padding-bottom:20px">
									<div class="team-member">
										<img alt="" class="img-responsive img-circle" src="images/bivek.jpg" style="height:110px;width:100px;">
										<h4 style="margin:5px 0 0 0;color:#08c">Bivek Kumar</h4>
										<p>
											Head Operations
								...
								<div class="col-sm-2" align="center" style="padding-bottom:20px">
									<div class="team-member">
										<img alt="" class="img-responsive img-circle" src="images/avinash.jpg" style="height:110px;width:100px;">
										<h4 style="margin:5px 0 0 0;color:#08c">Avinash Kumar</h4>
										<p>
											Lead Data Analyst
